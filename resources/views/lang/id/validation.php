...
return [
    ...
    | aturan ukuran (size). Silakan sesuaikan setiap pesan di sini.
    |
    */
    ...
    'between' => [
        ...
        'string' => ':attribute harus berjumlah antara :min - :max karakter.',
    ],
    ...
    'present_with_all' => ':attribute wajib ada apabila semua :values ada.',
    ...
    |--------------------------------------------------------------------------
    |
    | Di sini kamu bisa menentukan pesan validasi khusus untuk kombinasi
    | atribut dan aturan tertentu, sehingga bisa membuat pesan
    | pengecualian yang lebih spesifik.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Baris berikut digunakan untuk mengganti placeholder :attribute
    | dengan sesuatu yang lebih ramah dibaca, seperti "Alamat Email"
    | daripada "email".
    |
    */
    ...
    'attributes' => [
        ...
        'hero_image' => 'gambar sampul',
        'favicon' => 'favicon',
        'school_name' => 'nama sekolah',
        'school_address' => 'alamat sekolah',
        'school_city' => 'kota sekolah',
        'school_email' => 'email sekolah',
        'school_government_line' => 'garis pemerintahan sekolah',
        'principal_name' => 'nama kepala sekolah',
        'waka_kesiswaan_name' => 'nama waka kesiswaan',
        'summon_letter_threshold' => 'ambang batas surat panggilan',
